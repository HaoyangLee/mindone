...
def get_latent_z(model, videos):
    ...
    model_export(model.encode_first_stage, [x], name="encode_first_stage", model_save_path="./models_256/mindir")
...
def image_guided_synthesis(model,
    ...
    img = videos[:,:,0] #bchw
    model_export(model.embedder, [img], name="img_cond_stage", model_save_path="./models_256/mindir")
    img_emb = model.embedder(img) ## blc
    model_export(model.image_proj_model, [img_emb], name="image_proj_stage", model_save_path="./models_256/mindir")
    ...
    for _ in range(n_samples):
        ...
        model_export(model.decode_first_stage, [samples], name="decode_first_stage", model_save_path="./models_256/mindir")
...
def main(args):
    ...
    model.export_mindir = True
    # import pdb;pdb.set_trace()

    # assert os.path.exists(args.ckpt_path), "Error: checkpoint Not Found!"
    
    # if False:  # For convenience of testing
    if args.ckpt_path:
