...
hunyuanvideo_path = os.path.abspath("../")
...
from hunyuanvideo.hyvideo.constants import PRECISION_TO_TYPE, PRECISIONS, VAE_PATH
from hunyuanvideo.hyvideo.utils.data_utils import preprocess_video, read_video
from hunyuanvideo.hyvideo.utils.ms_utils import init_env
# from hunyuanvideo.hyvideo.vae import load_vae
from opensora.models.hunyuan_vae.autoencoder_kl_causal_3d import CausalVAE3D_HUNYUAN


logger = logging.getLogger(__name__)

# copied from configs/opensora-v2-0/inference/256px.yaml
ae_config = dict(
    # type="hunyuan_vae",
...
def main(args):
    ...
    vae = CausalVAE3D_HUNYUAN(**ae_config).set_train(False)  # FIXME: add DC-AE support
    ...
    if args.input_type == "video":
        ...
        test_vae_encoder_decoder(args, vae, vae, dtype)
