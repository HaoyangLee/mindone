...
def main(args):
    ...
    ) = prepare_captions(**args.text_emb)
    ...
    if args.enable_sequence_parallel:
        ...
        logger.info(f"Total number of captions: {max(len(full_prompts), len(full_t5_embeds))}")
    ...
    if sampling_option.use_t2i2v and num_prompts:
        ...
        offset = sampling_option_t2i.num_samples * num_prompts * rank_id
